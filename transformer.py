...
class Transformer():
    def __init__(self, src_vocab_size, trg_vocab_size):
        ...
        self.positional_encoding = PositionalEncoding(d_model, drop_out_rate, seq_len)
    ...
    def forward(self, src_seq, trg_seq, enc_mask=None, dec_mask=None):
        ...
        src_seq = self.postitional_encoding(src_seq) # (B, seq_len, d_model)
        trg_seq = self.postitional_encoding(trg_seq) # (B, seq_len, d_model)
